...
import { VideoDetailsListRelationFilter } from "../../videoDetails/base/VideoDetailsListRelationFilter";
...
class VideoWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => VideoDetailsListRelationFilter,
  })
  @ValidateNested()
  @Type(() => VideoDetailsListRelationFilter)
  @IsOptional()
  @Field(() => VideoDetailsListRelationFilter, {
    nullable: true,
  })
